...
function TableExample() {
  ...
  useEffect(() => {
    async function getTableData() {
      ...
      }/prisma/alluser?sortBy=${tableProperty.sortBy}&sortMethod=${
        tableProperty.sortMethod
      }&searchBy=${tableProperty.searchBy}&searchValue=${
        tableProperty.searchValue
      }&page=${tableProperty.page}&maxPerpage=${tableProperty.maxPerpage}`;
